...
/*!
 * @brief set up orthographic projection matrix by left hand
 *
 * @param[in]  left    viewport.left
 * @param[in]  right   viewport.right
 * @param[in]  bottom  viewport.bottom
...
CGLM_INLINE
void
glm_ortho_lh(float left, float right,
             float bottom, float top,
             float nearVal, float farVal,
             mat4  dest) {
    float rl, tb, fn;
...
/*!
 * @brief set up perspective projection matrix by left hand
 *
...
/*!
 * @brief set up view matrix by left hand
 *
